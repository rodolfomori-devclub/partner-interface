      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            ...
            <p className="text-white/60 text-sm mt-2">
              Conectando alunos do DevClub para estudarem juntos
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-16">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link to="/register" className="text-white/60 hover:text-primary transition-colors">
                    Cadastrar-se
                  </Link>
                </li>
              </ul>
        ...
        <div className="border-t border-white/10 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-white/60 text-sm">
            &copy; {currentYear} DevClub - Encontre um Partner
          </p>
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            ...
            <a
              href="https://facebook.com/devclub"
              target="_blank"
              rel="noopener noreferrer"
              className="text-white/60 hover:text-primary transition-colors"
              aria-label="Facebook"
